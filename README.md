...
Client side routing allows for faster loading times. This is enabled
through swapping different rendered components based on what events
have taken place, instead of making a call to an api everytime a new
